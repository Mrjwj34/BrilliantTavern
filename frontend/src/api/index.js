...
export const commentAPI = {
  ...
  /**
   * 创建评论
   * @param {Object} requestData - 创建评论请求
   * @param {string} requestData.cardId - 角色卡ID
   * @param {string} requestData.content - 评论内容
   * @param {number} requestData.parentCommentId - 父评论ID（可选）
   */
